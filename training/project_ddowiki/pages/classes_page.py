class ClassesPage:
    ...
    def hit_die_check(self,class_name):
        ...
        alignment_failsafe_parts = hit_dice_line.split(":") #the wiki is inconsistent and some classes has their alignment in the same lien as the hit die this makes help making sure i take the last : in case the lines are fused in the wiki
